...
export const requests = pgTable("requests", {
  ...
  baOwnerId: bigint("ba_owner_id", { mode: "number" }).references(() => users.id),
  devOwnerId: bigint("dev_owner_id", { mode: "number" }).references(() => users.id),
  qaOwnerId: bigint("qa_owner_id", { mode: "number" }).references(() => users.id),
