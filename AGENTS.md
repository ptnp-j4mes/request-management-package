# AGENTS.md — Request Management Platform
...
**Repository:** `/Users/bic-patanaphong/Documents/GitHub/management-request-platform`
**Git remote:** `https://github.com/ptnp-j4mes/management-request-platform`
...
| `mit_items`            | id, mit_no, project_id, request_id, status, current_step_code, current_owner_user_id _(snapshot fields)_ |
